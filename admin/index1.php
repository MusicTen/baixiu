<?php 
  ...
  $drafSql = "select count(*) as total from posts where status = 'drafted'";
  ...
  $drafTotal = my_query($drafSql)[0]['total'];
          ...
          <div class="panel panel-default">
            ...
            <ul class="list-group">
              <li class="list-group-item"><strong><?php echo $postTotal ?>
                      </strong>篇文章（<strong><?php echo $drafTotal ?></strong>篇草稿）</li>
              <li class="list-group-item"><strong><?php echo $cateTotal ?></strong>个分类</li>
              <li class="list-group-item"><strong><?php echo $comTotal ?>
                      </strong>条评论（<strong><?php echo $heldTotal ?></strong>条待审核）</li>
            </ul>
          </div>
        </div>
